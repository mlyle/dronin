 ...
 */
SystemHealthGadgetWidget::SystemHealthGadgetWidget(QWidget *parent)
    : QGraphicsView(parent)
{
    ...
    connect(telMngr, &TelemetryManager::connected, this,
            &SystemHealthGadgetWidget::onAutopilotConnect);
        ...
        if (m_renderer->elementExists(element)) {
            ...
            if (m_renderer->elementExists(element2)) {
                ...
                if ((value.compare("Uninitialised") != 0) && !warningClean.contains(element2)) {
                    qDebug() << "[SystemHealth] Warning: The SystemHealth SVG does not contain a "
                                "graphical element for the "
                             << element2 << " alarm.";
                    warningClean.append(element2);
                }
            }
        } else if (!warningClean.contains(element)) {
            qDebug() << "[SystemHealth] Warning: The SystemHealth SVG does not contain a graphical "
                        "element for the "
                     << element << " alarm.";
...
void SystemHealthGadgetWidget::showAlarmDescriptionForItemId(const QString itemId,
    ...
    if (itemId.contains("SystemConfiguration-")) {
        ...
        case SystemAlarms::CONFIGERROR_STABILIZATION:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/SystemConfiguration-Error-Stabilization.html");
            break;
        case SystemAlarms::CONFIGERROR_NAVFILTER:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/SystemConfiguration-Error-NavFilter.html");
            break;
        case SystemAlarms::CONFIGERROR_MULTIROTOR:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/SystemConfiguration-Error-Multirotor.html");
            break;
        case SystemAlarms::CONFIGERROR_AUTOTUNE:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/SystemConfiguration-Error-AutoTune.html");
            break;
        case SystemAlarms::CONFIGERROR_ALTITUDEHOLD:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/SystemConfiguration-Error-AltitudeHold.html");
            break;
        case SystemAlarms::CONFIGERROR_POSITIONHOLD:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/SystemConfiguration-Error-PositionHold.html");
            break;
        case SystemAlarms::CONFIGERROR_DUPLICATEPORTCFG:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/SystemConfiguration-Error-DuplicatePortCfg.html");
            break;
        case SystemAlarms::CONFIGERROR_PATHPLANNER:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/SystemConfiguration-Error-PathPlanner.html");
            break;
        case SystemAlarms::CONFIGERROR_UNSAFETOARM:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/SystemConfiguration-Error-UnsafeToArm.html");
            break;
        ...
        case SystemAlarms::MANUALCONTROL_SETTINGS:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/ManualControl-Critical-Settings.html");
            break;
        case SystemAlarms::MANUALCONTROL_NORX:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/ManualControl-Warning-NoRx.html");
            break;
        case SystemAlarms::MANUALCONTROL_ACCESSORY:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/ManualControl-Warning-Accessory.html");
            break;
        case SystemAlarms::MANUALCONTROL_ALTITUDEHOLD:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/ManualControl-Error-AltitudeHold.html");
            break;
        ...
        case SystemAlarms::STATEESTIMATION_GYROQUEUENOTUPDATING:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/StateEstimation-Gyro-Queue-Not-Updating.html");
            break;
        case SystemAlarms::STATEESTIMATION_ACCELEROMETERQUEUENOTUPDATING:
            alarmDescriptionFileName = QString(
                ":/systemhealth/html/StateEstimation-Accelerometer-Queue-Not-Updating.html");
            break;
        ...
        case SystemAlarms::STATEESTIMATION_NOMAGNETOMETER:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/StateEstimation-No-Magnetometer.html");
            break;
        case SystemAlarms::STATEESTIMATION_NOBAROMETER:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/StateEstimation-No-Barometer.html");
            break;
        case SystemAlarms::STATEESTIMATION_TOOFEWSATELLITES:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/StateEstimation-Too-Few-Satellites.html");
            break;
        case SystemAlarms::STATEESTIMATION_PDOPTOOHIGH:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/StateEstimation-PDOP-Too-High.html");
            break;
        case SystemAlarms::STATEESTIMATION_UNDEFINED:
            alarmDescriptionFileName =
                QString(":/systemhealth/html/StateEstimation-Undefined.html");
            break;
